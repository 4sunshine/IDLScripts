...
;      writeu, lun, swap_endian(obj.(i), /swap_if_big_endian)
  ...
  ;sc = 2771
  sc = 1.
  scl = 696*2*3.14/360.0*0.0297*2.
  box = CREATE_STRUCT('BX', Bx*sc, 'BY', By*sc, 'BZ', Bz*sc)
  write_vtk, box, 'D:\11feb2014_7.vtk', x = findgen(219),  y = findgen(159),  z = findgen(68), spacing = [1.0,1.0,1.0]*scl
